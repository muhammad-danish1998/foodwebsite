    ...
    <div className="min-h-screen bg-gray-100">
          ...
          <>
            <div className="mx-auto max-w-8xl px-4 sm:px-6 lg:px-8">
              <div className="relative flex justify-between lg:gap-8 xl:grid xl:grid-cols-12">
                ...
                <div className="min-w-0 flex-1 md:px-8 lg:px-36 xl:col-span-6">
      ...
      <div className="py-6">
        <div className="mx-auto max-w-3xl sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-12 lg:gap-8 lg:px-8">
          ...
          <main className="lg:col-span-9 xl:col-span-8 bg-yellow-200">{/* Your content */}a</main>
          <aside className=" xl:col-span-4 xl:block">
            <div className="sticky top-6 space-y-4 bg-green-200">{/* Your content */}s</div>
          </aside>
        </div>
      </div>
    </div>
